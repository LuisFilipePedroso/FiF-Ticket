    ...
    (
      <div tw="flex flex-col items-center bg-white relative">
        ...
        <div tw="w-full h-20 bg-white flex justify-center items-center relative z-40">
          <img src="http://localhost:3000/down-wave-1.svg" alt="Down Wave" tw="absolute -top-2 w-full " style={{ objectFit: "cover" }} />
          <h3 tw="font-normal text-lg tracking-wide">@{username}</h3>
          <img src="http://localhost:3000/up-wave-1.svg" alt="Up Wave" tw="absolute top-12 w-full" style={{ objectFit: "cover" }} />
        </div>
        <div tw="flex w-full justify-center bg-emerald-100">
          <img src="http://localhost:3000/bg.png" alt="FiF bridge" tw="mt-8 w-full" style={{ objectFit: "cover" }} />
        </div>
